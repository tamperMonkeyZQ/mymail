...
public class OhMyEmail {
    ...
    public static Properties defaultConfig(Boolean debug) {
        ...
        props.put("mail.smtp.ssl.enable", "false"); //ssl关闭
    ...
    public static Properties SMTP_ZQ(boolean debug) {
        Properties props = defaultConfig(debug);
        props.put("mail.smtp.host", "smtp.healthcarerzq.com");
        return props;
    }
     ...
     */
    public static com.tamper.mymail.services.OhMyEmail subject(String subject) throws SendMailException {
        com.tamper.mymail.services.OhMyEmail ohMyEmail = new com.tamper.mymail.services.OhMyEmail();
     ...
     */
    public com.tamper.mymail.services.OhMyEmail from(String nickName) throws SendMailException {
     ...
     */
    public com.tamper.mymail.services.OhMyEmail from(String nickName, String from) throws SendMailException {
        try {
    ...
    public com.tamper.mymail.services.OhMyEmail replyTo(String... replyTo) throws SendMailException {
    ...
    public com.tamper.mymail.services.OhMyEmail to(String... to) throws SendMailException {
        try {
    ...
    public com.tamper.mymail.services.OhMyEmail cc(String... cc) throws SendMailException {
        try {
    ...
    public com.tamper.mymail.services.OhMyEmail bcc(String... bcc) throws SendMailException {
        try {
    ...
    public com.tamper.mymail.services.OhMyEmail bcc(String bcc) throws MessagingException {
        return addRecipient(bcc, Message.RecipientType.BCC);
    }

    private com.tamper.mymail.services.OhMyEmail addRecipients(String[] recipients, Message.RecipientType type) throws MessagingException {
        String result = Arrays.asList(recipients).toString().replace("(^\\[|\\]$)", "").replace(", ", ",");
        msg.setRecipients(type, InternetAddress.parse(result));
        return this;
    }

    private com.tamper.mymail.services.OhMyEmail addRecipient(String recipient, Message.RecipientType type) throws MessagingException {
        msg.setRecipients(type, InternetAddress.parse(recipient.replace(";", ",")));
        return this;
    }

    public com.tamper.mymail.services.OhMyEmail text(String text) {
        this.text = text;
        return this;
    }

    public com.tamper.mymail.services.OhMyEmail html(String html) {
        this.html = html;
        return this;
    }

    public com.tamper.mymail.services.OhMyEmail attach(File file) throws SendMailException {
        attachments.add(createAttachment(file, null));
        return this;
    }

    public com.tamper.mymail.services.OhMyEmail attach(File file, String fileName) throws SendMailException {
        attachments.add(createAttachment(file, fileName));
        return this;
    }

    public com.tamper.mymail.services.OhMyEmail attachURL(URL url, String fileName) throws SendMailException {
